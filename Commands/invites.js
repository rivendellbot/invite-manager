...
exports.run = async (client, message, args) => {
    ...
    .setDescription(`Vous avez **${(data.total || 0) + (data.bonus || 0)}** invites! (**${data.regular || 0}** regular, **${data.bonus || 0}** bonus, **${data.leave || 0}** membres qui sont partit, **${data.fake || 0}** fake)`)
    .setColor("RANDOM");
